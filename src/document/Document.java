...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		double words1 = (double) getNumWords();
				double sentences1 = ( double) getNumSentences();
				double sylables = (double) getNumSyllables();
		double temp1 =  	words1/sentences1;
		double temp2 =    sylables/words1;
		double result = 0;
		double r1 = 206.835;
		double r2 = 1.015*temp1;
		double r3 = 84.6*temp2;
		result = r1-r2-r3;
	    return result;
	}
